...
import trendPage from './page/ai-trend.js';
import pageConfig from './page.js';
export default [geo, demo, demoSitemap, demoSitemapState, demoSitemapCounty, demoSitemapCity, indexPage, trendPage, pageConfig];
